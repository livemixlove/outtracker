...
import {
    OuttrackerStateRecord, ChatMessageRecord, dateFormat, OutageRecord, OutageRecordedInput, OutageDescriptor,
...
const ADD_DESCIBE_TO_OUTAGE = (state, action) => addOutageDescriptorOfType(state, action, OutageDescriptor)

const RECORD_INPUT_TO_OUTAGE = (state, action) => addOutageDescriptorOfType(state, action, OutageRecordedInput)
...
const addOutageDescriptorOfType = (state, action, DesciptorType) => {
    ...
    state = state.update(
        ...
        (descriptors) => {
            ...
            descriptors = descriptors.update(
                currentOutageId,
                list => list.push(new DesciptorType({
